...
export const NS_PER_SEC = 1000000000n;
/** Nanoseconds per millisecond */
export const NS_PER_MS = 1000000n;
...
export function toTimestamp(input) {
    ...
    if (typeof input === 'number') {
        ...
        if (input < SEC_MS_THRESHOLD) {
            // Treat as seconds
            return (BigInt(Math.floor(input)) * NS_PER_SEC +
    ...
    if (typeof input === 'string') {
        ...
        if (match) {
            ...
            if (match[2]) {
                ...
                const nsecStr = match[2].length > 9
 ...
 * ```
 */
export function toTimeSpec(timestamp) {
 ...
 * ```
 */
export function toTimespec(input) {
 ...
 */
export function toString(timestamp, format = 'iso') {
    switch (format) {
        case 'iso':
 ...
 */
export function addNanoseconds(timestamp, nanoseconds) {
 ...
 */
export function diffNanoseconds(later, earlier) {
 ...
 */
export function diffMilliseconds(later, earlier) {
 ...
 */
export function diffSeconds(later, earlier) {
 ...
 */
export function round(timestamp, precision) {
    switch (precision) {
        case 'second':
