 ...
 * ```
 */
export function isValidErrno(code) {
 ...
 * ```
 */
export function normalizeErrno(code) {
    if (code === 0)
        return 0; // Success
 ...
 */
export function isExistsError(code) {
    const errCode = typeof code === 'string' ? errno(code) : code;
 ...
 */
export function isTemporaryError(code) {
    const errCode = typeof code === 'string' ? errno(code) : code;
 ...
 */
export function isIOError(code) {
    const errCode = typeof code === 'string' ? errno(code) : code;
 ...
 */
export function isInvalidError(code) {
    const errCode = typeof code === 'string' ? errno(code) : code;
 ...
 * ```
 */
export function createFuseError(code, message, syscall, path) {
    return new FuseErrno(code, message, syscall, path);
}
/**
 * Common FUSE error creators for convenience
 */
export const createENoent = (path) => createFuseError('ENOENT', undefined, undefined, path);
export const createEAcces = (path) => createFuseError('EACCES', undefined, undefined, path);
export const createEExist = (path) => createFuseError('EEXIST', undefined, undefined, path);
export const createEIsDir = (path) => createFuseError('EISDIR', undefined, undefined, path);
export const createENotDir = (path) => createFuseError('ENOTDIR', undefined, undefined, path);
export const createEInval = (message) => createFuseError('EINVAL', message);
export const createEIO = (message) => createFuseError('EIO', message);
export const createENoSpc = () => createFuseError('ENOSPC');
export const createENotEmpty = (path) => createFuseError('ENOTEMPTY', undefined, undefined, path);
// =============================================================================
 ...
 */
export function getOperationErrors(operation) {
 ...
 */
export function isValidOperationError(operation, code) {
